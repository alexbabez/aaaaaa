...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Snopy",
    description: `A Community Manager and Moderator fosters a positive environment, engages with members, enforces community guidelines, and facilitates communication while supporting growth and user satisfaction..`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Snopy" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Snopy" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Snopy</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Snopy. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
